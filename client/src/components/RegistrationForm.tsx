            ...
            >
              ...
              <div className="flex items-start space-x-3 p-4 rounded-lg border-2 bg-muted/50 opacity-60 cursor-not-allowed">
                ...
                <Label htmlFor="turma_2" className="flex-1">
                  <div className="font-semibold text-foreground">Turma 2 — Segundas-feiras <span className="text-red-600 font-bold ml-2">ENCERRADA</span></div>
                </Label>
              </div>
              <div className="flex items-start space-x-3 p-4 rounded-lg border-2 bg-muted/50 opacity-60 cursor-not-allowed">
                <RadioGroupItem value="turma_1" id="turma_1" data-testid="radio-turma1" disabled />
                <Label htmlFor="turma_1" className="flex-1">
                  <div className="font-semibold text-foreground">Turma 1 — Segundas-feiras <span className="text-red-600 font-bold ml-2">ENCERRADA</span></div>
                </Label>
              </div>
            </RadioGroup>
            {errors.turma && (
