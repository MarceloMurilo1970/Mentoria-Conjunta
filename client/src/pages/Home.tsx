...
export default function Home() {
  ...
  const [selectedTurma, setSelectedTurma] = useState<"turma_3" | "turma_4" | "turma_5">("turma_5");
              ...
              {batchesOpen ? (
                ...
                <Card className="max-w-2xl mx-auto border-muted">
                  <CardContent className="py-12 text-center">
                    ...
                    <p className="text-muted-foreground">
                      {comingSoon ? 'A Turma 5 começa em 14 de outubro de 2026. As inscrições abrem em breve!' : 'O período de inscrições foi encerrado.'}
                    </p>
                  </CardContent>
                </Card>
              )}
