  ...
  app.get("/api/restore-registrations", async (req, res) => {
    try {
      const registrationsToRestore = [
        {
          ...
          email: 'marcos.argachoy@outlook.com.br',
          phone: '11986129225',
          cpfCnpj: '11986129225',
          ...
          paidAmount: 8875,
          totalAmount: 8875,
          vendor: 'Marcelo Murilo',
          batch: 1,
          createdAt: new Date('2025-12-06T15:32:00'),
        },
        {
          name: 'Katya Mangili',
          email: 'kmmangili@gmail.com',
          phone: '19974090818',
          cpfCnpj: '19974090818',
          ...
          paidAmount: 4000,
          totalAmount: 8000,
          remainingPaymentDate: new Date('2026-02-07'),
          vendor: 'Marcelo Murilo',
          batch: 1,
          createdAt: new Date('2025-12-08T14:47:00'),
        },
        {
          name: 'Paulo Figueiredo Neves',
          email: 'psfn2000@gmail.com',
          phone: '31992980898',
          cpfCnpj: '22175610659',
          paymentMethod: 'installments' as const,
          ...
          vendor: 'Marcelo Murilo',
          batch: 3,
          createdAt: new Date('2026-01-10T07:42:00'),
        },
        {
          name: 'Helder Waiandt',
          email: 'h.waiandt@uptecsolutions.com',
          phone: '+1 (713) 416 8257',
          cpfCnpj: '909.999.328-72',
          paymentMethod: 'pix' as const,
          paymentStatus: 'pago',
          paidAmount: 8700,
          totalAmount: 8700,
          vendor: 'Leandro Massaneiro',
          batch: 2,
          observations: 'Pago dia 14/01 às 14:04.',
          createdAt: new Date('2026-01-13T19:10:00'),
        },
        {
          name: 'Fábio Ricardo Geremias',
          email: 'ffr.geremias@gmail.com',
          phone: '+55 27 99771-4424',
          cpfCnpj: '440.177.740-91',
          paymentMethod: 'installments' as const,
          paymentStatus: 'pendente',
          paidAmount: 0,
          totalAmount: 9650,
          vendor: 'Marcelo Murilo',
          batch: 2,
          observations: 'Vai pagar no cartão dia 10/02',
          createdAt: new Date('2026-01-14T09:00:00'),
        },
        {
          name: 'Denys Emilio Nicolosi',
          email: 'denys@wietech.com.br',
          phone: '11973691078',
          cpfCnpj: '67958460830',
          paymentMethod: 'installments' as const,
          paymentStatus: 'pendente',
          ...
          totalAmount: 10425,
          batch: 3,
          createdAt: new Date('2026-01-24T19:03:00'),
        },
      ];
      ...
      for (const reg of registrationsToRestore) {
        ...
        const existing = await storage.getRegistrationByEmail(reg.email);
        if (existing) {
          results.push({ name: reg.name, status: 'Já existe' });
          continue;
        }
        
        // Use createManualRegistration which supports all fields
        await storage.createManualRegistration({
          name: reg.name,
          email: reg.email,
          phone: reg.phone,
          cpfCnpj: reg.cpfCnpj,
          paymentMethod: reg.paymentMethod,
          paymentStatus: reg.paymentStatus as "pendente" | "parcial" | "pago",
        ...
        // Update batch and other fields using specific update functions
        const created = await storage.getRegistrationByEmail(reg.email);
        if (created) {
          await storage.updateBatch(created.id, { batch: reg.batch });
          if (reg.remainingPaymentDate) {
            await storage.updatePaymentStatus(created.id, {
              paymentStatus: reg.paymentStatus as "pendente" | "parcial" | "pago",
              paidAmount: reg.paidAmount,
              remainingPaymentDate: reg.remainingPaymentDate,
            });
          }
          if (reg.vendor) {
            await storage.updateVendor(created.id, { vendor: reg.vendor });
          }
        }
        results.push({ name: reg.name, status: 'Restaurado' });
      }
