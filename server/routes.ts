...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.patch("/api/registrations/:id/payment-status", async (req, res) => {
    try {
      ...
      // Frontend sends values in reais, convert to centavos for DB (integer)
      const effectiveTotalCentavos = Math.round((totalAmount || registration.totalAmount / 100 || 0) * 100);
      let validatedPaidAmountCentavos = 0;
      ...
      if (paymentStatus === 'parcial') {
        ...
        validatedPaidAmountCentavos = Math.round(paidNum * 100);
  ...
  const BATCH_CONFIG = [
    ...
    { batch: 3, pixPrice: 10756.65, installmentPrice: 2389.61, installments: 5, installmentTotal: 11948.07, paymentLink: "https://link.infinitepay.io/mentoria-mm/VC1DLTUtSQ-WOHFgM1mHD-11950,00", installment10Price: 1297, installment10Total: 12970, paymentLink10: "https://link.infinitepay.io/mentoria-mm/VC1DLUEtSQ-Z62S8A2tl5-12970,00" },
    { batch: 4, pixPrice: 10756.65, installmentPrice: 2389.61, installments: 5, installmentTotal: 11948.07, paymentLink: "https://link.infinitepay.io/mentoria-mm/VC1DLTUtSQ-WOHFgM1mHD-11950,00", installment10Price: 1297, installment10Total: 12970, paymentLink10: "https://link.infinitepay.io/mentoria-mm/VC1DLUEtSQ-Z62S8A2tl5-12970,00" },
  ];
